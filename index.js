...
app.get("/getBookings/:userId", (req, responseApi) => {
  getBookingsForUserId(req, responseApi);
});

app.get("/cancelBooking/:bookingId", (req, responseApi) => {
  cancelBooking(req, responseApi);
});
